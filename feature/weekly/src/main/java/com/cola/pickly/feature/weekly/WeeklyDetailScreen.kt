...
import com.cola.pickly.core.ui.components.FullScreenPhotoViewer
import com.cola.pickly.feature.weekly.WeeklyListViewModel
import com.cola.pickly.core.ui.R
import androidx.compose.ui.res.painterResource
import com.cola.pickly.feature.weekly.components.AllPhotosSection
import com.cola.pickly.feature.weekly.components.RecommendedPhotosSection
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        uiState.fullScreenState?.let {
            FullScreenPhotoViewer(
                ...
                recommendedIconPainter = painterResource(id = R.drawable.ic_badge_heart)
            )
        }
    }
}