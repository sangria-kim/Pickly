package com.cola.pickly.core.domain.repository
...
interface PhotoRepository {
     ...
     */
    suspend fun getPhotosInFolder(folderRelativePath: String): List<Photo>
     ...
     * @return [Photo]의 리스트
     */
    suspend fun getPhotosByBucketId(bucketId: String): List<Photo>
